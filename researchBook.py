...
class ResearchBook(Book):
    def __init__(self):
        ...
        #self.top5_ask_price_cache = None
        #self.top5_bid_price_cache = None
    ...
    '''
    @property
    def top5_ask_price(self):
        self.top5_ask_price_cache = self.asks.minpp()
        return self.top5_ask_price_cache
    
    @property
    def top5_bid_price(self):
        self.top5_bid_price_cache = self.bids.maxpp()
        return self.top5_bid_price_cache
    '''
    @property
    def bid_volume(self):
    ...
    @property
    def ex1(self):
        return nlargest(5,list(self.bids.price_map.keys()))

    @property
    def ex2(self):
        return nsmallest(5,list(self.asks.price_map.keys()))
    
    @property
    def ex3(self):
        return [self.bids.price_map[x].volume for x in nlargest(5,list(self.bids.price_map.keys()))  ]
    
    @property
    def ex4(self):
        return [self.asks.price_map[x].volume for x in nsmallest(5,list(self.asks.price_map.keys()))  ]