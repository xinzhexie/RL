...
def append_point(quotebook):
    ...
    values['bid'] = quotebook.ex1
    values['ask'] = quotebook.ex2
    values['bidorder'] = quotebook.ex3
    values['asdorder'] = quotebook.ex4
    #values['top5_ask'] = quotebook.top5_ask_price
    #values['top5_bid'] = quotebook.top5_bid_price
